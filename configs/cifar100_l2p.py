...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--epochs', default=80, type=int)
    ...
    subparsers.add_argument('--pretrained', default=False, help='Load pretrained model or not')
    ...
    subparsers.add_argument('--weight-decay', type=float, default=1e-4, help='weight decay (default: 0.0)')
    ...
    # Data parameters
    subparsers.add_argument('--data-path', default='/data00/jiahao/data/longtailed_dataset/CIFAR', type=str, help='dataset path')
    ...
    # Prompt parameters
    subparsers.add_argument('--prompt_pool', default=False, action='store_true')
    ...
    subparsers.add_argument('--layer_prompt_length', default=5, type=int)
    subparsers.add_argument('--layer_prompt_depth', default=12, type=int)
    ...
    subparsers.add_argument('--freeze', default=['blocks', 'patch_embed', 'norm', 'pos_embed', 'cls_token', 'head_cls_token', 'medium_cls_token', 'few_cls_token'], nargs='*', type=str, help='freeze part in backbone model')

    # Misc parameters
    subparsers.add_argument('--print_freq', type=int, default=10, help = 'The frequency of printing')

    subparsers.add_argument('--ckpt', type=str, default='/data00/jiahao/l2p-pytorch-main/longtailed-l2p/pretrained_model/ViT-B_16.npz', help = 'load model path')
    subparsers.add_argument('--balanced_sampler', action='store_true')

    subparsers.add_argument('--task', type=str, default='cifar100')